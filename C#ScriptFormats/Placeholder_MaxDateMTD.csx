...
/* Annotation Measure **************************************************************************/
    var _mAnnotation =
            __ + 
            " -- MaxDate - Year to Date (last complete month) "                            
            + __
            ;
...
/* Dax Expression ******************************************************************************/
    var _daxExpression = __ +
             var_ + var_Name + 
            "= CALCULATE (" +maxDimDate+ ", DIM_Dates[isMonthComplete] = TRUE )"            
            + __
            ;

/* Meta Description ****************************************************************************/
    var _mDescription =
            "Latest Complete Month YTD of " +col_DimDates+ ": " 
            + ___ +
            "• Last Visible Date"
            ;
